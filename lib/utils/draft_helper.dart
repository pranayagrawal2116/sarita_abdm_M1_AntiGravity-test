...
Future<String> saveDraft(String abhaId, String patientName, String fileName, String content) async {
  return await saveDraftImpl(abhaId, patientName, fileName, content);
}
